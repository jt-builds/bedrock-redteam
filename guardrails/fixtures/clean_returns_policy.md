...
Exchanges are available for items of equal or lesser value. For items of greater
value, the customer pays the difference. Exchanges follow the same condition
